...
/*
    ...
    lab2的实验内容跟szf.y没太大关系，这里只是建语法树的
...
#ifndef YY_YY_SZF_TAB_H_INCLUDED
# define YY_YY_SZF_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_SZF_TAB_H_INCLUDED  */
...
{
       0,    66,    66,    72,    73,    78,    82,    86,    92,    96,
     102,   106,   112,   118,   124,   125,   130,   136,   140,   148,
     153,   160,   164,   170,   176,   182,   183,   189,   193,   197,
     201,   207,   215,   223,   224,   229,   234,   238,   244,   248,
     255,   259,   263,   267,   271,   275,   280,   285,   291,   294,
     298,   304,   307,   311,   317,   320,   324,   330,   333,   339,
     342,   348,   351,   357,   360,   366,   370
};
#endif
...
static const char *const yytname[] =
{
  ...
  "FLOAT", "INT", "ID", "$accept", "Program", "ExtDefList", "ExtDef",
  "ExtDecList", "Specifier", "StructSpecifier", "OptTag", "Tag", "VarDec",
  "FunDec", "VarList", "ParamDec", "CompSt", "StmtList", "Stmt", "DefList",
  "Def", "DecList", "Dec", "Exp1", "Exp2", "Exp3", "Exp4", "Exp5", "Exp6",
  "Exp7", "Exp", "Args", YY_NULLPTR
};
#endif
